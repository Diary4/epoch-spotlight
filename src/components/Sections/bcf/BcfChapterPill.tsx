...
export default function BcfChapterPill({ title, thumb, className = "" }: BcfChapterPillProps) {
  return (
    <div className={`flex justify-center ${className}`}>
      <div className="relative flex min-w-[280px] items-center rounded-full bg-black/40 py-4 pl-[200px] pr-8 backdrop-blur-sm">
        <span
          className="absolute left-0 top-1/2 h-[160px] w-[160px] -translate-y-1/2 overflow-hidden rounded-full border-2"
