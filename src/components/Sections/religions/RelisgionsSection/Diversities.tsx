    ...
    <ReligionsScaledPage dir={dir} lang={lang} fitDeps={[lang]} sectionRef={sectionRef} className="px-12 pb-14">
      ...
      <div className="relative z-10 mx-auto max-w-[1180px]">
        <header data-map-animate="true" className="mx-auto max-w-[790px] pt-8 text-center">
          ...
          <p className="mx-auto mt-5 max-w-[650px] text-[22px] font-semibold leading-relaxed text-[#3f3528]">
            {pageDescription}
          </p>
        </header>
        ...
        <section className="mx-auto mt-4 grid max-w-[960px] grid-cols-3 gap-6">
