...
export const religionsPageContent: Record<ReligionsLangCode, ReligionsPageContent> = {
  ...
  ku: {
    ...
    subtitle: "کوردستان: لانکەی پێکەوەژیان",
    description:
    ...
    introQuote: "پێکەوەژیان تەنها دانبەخۆداگرتن نییە بەرامبەر ئەوی تر، بەڵکو بەرزڕاگرتنیەتی.",
    introPillars: [
      {
        title: "ئایینەکان",
