...
const content: Record<LangCode, RightsOverviewContent> = {
  ...
  ku: {
    back: "گەڕانەوە",
    pageTitle: "مافەکان و دانپێدانان",
    pageDescription:
      "چوارچێوەی یاسایی بۆ پاراستنی هەموو پێکهاتەکان.",
    institutionsTab: "دامەزراوەکان",
    sanctuaryTab: "پەناگە",
    institutions: {
      subtitle: "حکومەتێک بۆ هەموو هاووڵاتیان",
      ...
      cards: [
        ...
        },
        {
          ...
          subtitle: "بۆ هەموو پێکهاتەکان کورسی هەیە",
          icon: ICONS.parliament,
          accent: ACCENTS.parliament,
        },
        {
          id: "laws",
          title: "یاساکان و پاراستن",
          subtitle: "ماف، کەرامەت و پێکەوەژیان",
          icon: ICONS.laws,
          accent: ACCENTS.laws,
        },
      ],
    ...
    sanctuary: {
      subtitle: "کاتێک جیهان سەیری دەکرد، کوردستان هەنگاوی نا",
      tagline: "ماڵێکی ئارام لە کاتە سەختەکاندا.",
      cards: [
        {
          id: "year2014",
          title: "٢٠١٤ — کوردستان دەرگاکانی واڵا کرد",
          subtitle: "کاتێک جیهان سەیری دەکرد، کوردستان هەنگاوی نا",
          icon: ICONS.year2014,
          accent: ACCENTS.year2014,
        },
        {
          id: "refuge",
          title: "کوردستان — ماڵێکی ئارام",
          subtitle: "ئارامی، کەرامەت و شوێنێک بۆ بوون",
          icon: ICONS.refuge,
          accent: ACCENTS.refuge,
        },
        {
          ...
          subtitle: "ڕۆڵی دامەزراوەکان و میدیا لە گەشەپێدانی فەرهەنگی لێبوردەیی",
          icon: ICONS.media,
          accent: ACCENTS.media,
        },
      ],
  ...
  ar: {
    ...
    pageDescription:
      "أطر قانونية تحمي كل مجتمع.",
    institutionsTab: "المؤسسات",
    sanctuaryTab: "الملاذ",
    institutions: {
      subtitle: "حكومة لجميع أبنائها",
      ...
      cards: [
        ...
        },
        {
          ...
          subtitle: "الحقوق والكرامة والتعايش",
          icon: ICONS.laws,
          accent: ACCENTS.laws,
        },
      ],
    ...
    sanctuary: {
      subtitle: "حين راقب العالم، تصرفت كوردستان",
      tagline: "بيت آمن في الأوقات العصيبة.",
      cards: [
        {
          id: "year2014",
          title: "2014 — كوردستان فتحت أبوابها",
          subtitle: "حين راقب العالم، تصرفت كوردستان",
          icon: ICONS.year2014,
          accent: ACCENTS.year2014,
        },
        {
          id: "refuge",
          title: "كوردستان — بيت آمن",
          subtitle: "الأمان والكرامة ومكان للانتماء",
          icon: ICONS.refuge,
          accent: ACCENTS.refuge,
        },
        {
          ...
          subtitle: "دور المؤسسات والإعلام في تعزيز ثقافة التسامح",
          icon: ICONS.media,
          accent: ACCENTS.media,
        },
      ],
...
const TAB_ORDER = ["institutions", "sanctuary"] as const;
  ...
  const navTabs = React.useMemo(
    () =>
      TAB_ORDER.map((id) => ({
        id,
        icon: TAB_ICONS[id],
        label: id === "institutions" ? c.institutionsTab : c.sanctuaryTab,
      })),
    [c],
  );

  // Decode both panels' art up front so switching tabs never pops in.
  usePreloadImages(React.useMemo(() => Object.values(CARD_IMAGES), []));
    ...
    >
      ...
      <div className="relative z-10 mx-auto flex min-h-full w-full max-w-[1220px] flex-col">
        ...
        <section data-rts-animate="true" className="mt-[920px] flex flex-1 flex-col pb-4">
          ...
          >
            {(key) => {
              const panel = key === "institutions" ? c.institutions : c.sanctuary;
              ...
              return (
                <>
                  ...
                  <div
                    data-tab-fx-group
                    className="grid w-full flex-1 grid-cols-3 content-stretch gap-5"
                  >
