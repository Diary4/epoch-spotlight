  ...
  ku: {
    ...
    locations: {
      erbil: {
        ...
        short: "هەولێر",
        description:
          "پارێزگای سەرەکیی BCF و فراوانترین ناوچەی کارەکانی دامەزراوەکەیە؛ پڕۆژەکانی خۆراک، قوتابخانە، ئاو، کەمپ، نیشتەجێکردن و ناوەندی لێهاتوویی بۆ چاودێری ئاڵۆز لەخۆدەگرێت.",
      ...
      sinjar: {
        ...
        short: "شنگال",
        description:
          "ئەو شوێنەی کاری فریاکەوتنی BCF لێوە دەستی پێکرد؛ وەڵامدانەوە بە تەقینەوەکانی ساڵی ٢٠٠٧، گەیاندنی یارمەتی بە هەلیکۆپتەر بۆ چیا لە ساڵی ٢٠١٤، و ئەو خانووانەی لەوێ لەو کاتەوە دروست کراون.",
        explore: "پڕۆژەکان ببینە",
      },
      garmian: {
        name: "گەرمیان / کەلار",
