...
const content: Record<"en" | "ku" | "ar", RightsDetailContent> = {
  ...
  ku: {
    ...
    pageSubtitle: "ڕۆڵی دامەزراوەکان و میدیا لە گەشەپێدانی فەرهەنگی لێبوردەیی",
    cards: [
      {
        id: "legal",
        eyebrow: "هاندانی پەخشی فەرهەنگی پێکەوەژیان",
        title: "هاندانی پەخشی فەرهەنگی پێکەوەژیان",
        body:
          "حکومەتی هەرێمی کوردستان لە ڕێگەی وەزارەتی ڕۆشنبیری و فەرمانگەی میدیا و زانیارییەوە، بەبەردەوامی داوا لە کەناڵەکانی ڕاگەیاندن دەکات کە بەرنامە و ناوەڕۆکی تایبەت بە بەهێزکردنی گیانی برایەتی، لێبوردەیی و یەکترقبوڵکردن لە نێوان سەرجەم ئایین و نەتەوەکاندا بەرهەم بهێنن و پەخشی بکەن.",
        icon: ScrollText,
        accent: "#52235f",
      },
      {
        id: "programs",
        eyebrow: "مافی پەخش بە زمانە دایک",
        title: "مافی پەخش بە زمانە دایک",
        body:
          "بەپێی یاسای زمانە فەرمییەکان (یاسای ژمارە ٦ی ساڵی ٢٠١٤)، حکومەت زەمینەی تەواوی ڕەخساندووە بۆ پێکهاتەکانی تورکمان، سریانی و ئەرمەن تاوەکو خاوەنی کەناڵی تەلەڤزیۆنی، ڕادیۆ و دەزگای ڕۆژنامەگەریی سەربەخۆی خۆیان بن و بە زمانی دایکی خۆیان پەیامەکانیان بگەیەنن.",
        icon: Tv,
        accent: "#7a4a12",
      },
      {
        id: "coverage",
        eyebrow: "قەدەغەکردنی گوتاری ڕق وکینە",
        title: "قەدەغەکردنی گوتاری ڕق وکینە",
        body:
          "بەپێی ڕێنماییە فەرمییەکانی کارکردنی میدیایی و یاسای پاراستنی مافی پێکهاتەکان (یاسای ژمارە ٥ی ساڵی ٢٠١٥)، هەر جۆرە گوتارێک یان بەرنامەیەک کە هانی توندڕەوی، سووکایەتیکردن بە پیرۆزییە ئایینییەکان یان ڕق وکینە بدات قەدەغە کراوە، و میدیاکان پابەند کراون بە پاراستنی کەرامەتی مرۆیی.",
        icon: Users,
        accent: "#16466b",
      },
      {
        id: "challenges",
        eyebrow: "ڕوومالی بێجیاوازیی جەژن و بۆنەکان",
        title: "ڕوومالی بێجیاوازیی جەژن و بۆنەکان",
        body:
          "لەسەر ڕاسپاردەی دەزگا پەیوەندیدارەکانی حکومەت، کەناڵەکانی ڕاگەیاندن گرنگییەکی تایبەت و یەکسان دەدەن بە ڕووماڵی ڕاستەوخۆی جەژن و بۆنە ئایینی و نەتەوەییەکانی موسڵمانان، مەسیحییەکان، ئێزدییەکان، کاکەیییەکان و تورکمانەکان، وەک ئەرکێکی نیشتمانی بۆ نیشاندانی تابلۆی جوان و فرەرەنگی کوردستان.",
        icon: AlertCircle,
        accent: "#6b1d1d",
      },
    ],
    tagline: "میدیا لە کوردستان پردێکە بۆ نزیککردنەوەی پێکهاتەکان و دەنگێکە بۆ پاراستنی یەکڕیزیی نیشتمانی.",
  },
  ar: {
    back: "العودة",
