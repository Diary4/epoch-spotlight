      ...
      <div className="relative z-10 mx-auto max-w-[1040px]">
        ...
        >
          ...
          <button
            ...
            className="grid h-16 w-16 shrink-0 place-items-center rounded-full bg-[#c58b16] text-white shadow-[0_8px_18px_rgba(75,45,12,0.18)] transition-transform duration-300 ease-smooth-out active:scale-95"
          >
