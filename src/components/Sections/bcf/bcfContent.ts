  ...
  ku: {
    ...
    storySections: [
      ...
      },
      {
        ...
        body: "وتەی «خزمەتکردنی گەلی خۆت، شانازییە» تەنها دروشمێک نییە؛ بەڵکو بنەمای ئەخلاقی کارەکانی دەزگای خێرخوازی بارزانییە. کاری مرۆیی بەخشینێک نییە لە سەرەوە، بەڵکو خزمەتکردنە بە کەرامەتەوە.",
      },
      {
        id: "values",
        titleGold: "بەهاکانی",
