    ...
    <ReligionsScaledPage dir={dir} lang={lang} fitDeps={[lang]} sectionRef={sectionRef} className="px-12 pb-14">
      ...
      <div className="relative z-10 mx-auto max-w-[980px]">
        ...
        >
          ...
          <h1 className="font-serif text-[92px] font-semibold uppercase leading-[1.04] tracking-[0.08em] text-[#2f1f12]">
          ...
          <p className="mt-4 font-serif text-[29px] font-semibold uppercase tracking-[0.09em] text-[#a46f22]">
            {pageSubtitle}
          </p>
          ...
          <p className="mx-auto mt-6 max-w-[650px] text-[24px] font-semibold leading-relaxed text-[#3f3528]">
            {pageDescription}
          </p>
        </header>
        ...
        <div
          data-language-animate="true"
          className="mb-5 mt-[420px] flex justify-end"
        >
        ...
        >
          ...
          <h2 className="font-serif text-[42px] font-semibold uppercase leading-tight text-[#3b2410]">
            {footerTitle}
          </h2>
