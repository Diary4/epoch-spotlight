      ...
      cards: [
        {
          ...
          body: "Following democratic elections on May 19, 1992 — the first in the region's history. Parliament was established with reserved minority seats from the very beginning.",
          icon: ou,
          accent: "#52235f",
        },
        {
          ...
          body: "Renamed in 2007 from “Islamic Affairs” to “Religious Affairs” — reflecting that it serves all faiths. Includes General Directorates for Christian and Yazidi Affairs.",
          icon: tu,
          accent: "#7a4a12",
        },
        {
          ...
          body: "Schools operate in Turkmen, Syriac, and Armenian. General Directorates for Syriac and Turkmen Education were established by law.",
          icon: su,
          accent: "#16466b",
        },
        {
          ...
          body: "The Ministry of Culture established General Directorates for Turkmen and Syriac Culture and Arts to preserve and develop minority heritage.",
          icon: lu,
          accent: "#244b1f",
        },
      ],
      ...
      cards: [
        {
          ...
          body: "In 2005 the Kurdistan Parliament increased minority seats from 5 to 11: 5 for Chaldo-Assyrians, 5 for Turkmen, and 1 for Armenians — a guarantee written into law.",
          icon: hu,
          accent: "#52235f",
        },
        {
          ...
          body: "Voted unanimously by the Kurdistan Parliament. Guarantees the political, religious, cultural, and linguistic rights of Turkmen, Chaldeans, Syriacs, Armenians, Christians, Yazidis, Mandaeans, Kakais, and Zoroastrians.",
          icon: uu,
          accent: "#7a4a12",
        },
        {
          ...
          body: "Decision No. 47 of 1992 established holidays for Christians and Assyrians. Resolution No. 6 of 2010 established Yazidi holidays. All communities are recognized in the official calendar.",
          icon: nu,
          accent: "#16466b",
        },
        {
          ...
          body: "Decision No. 11 of 2019 officially declared August 3 as Yazidi Genocide Day — recognizing the crimes of ISIS as genocide, crimes against humanity, and war crimes.",
          icon: ru,
          accent: "#6b1d1d",
        },
      ],
      ...
      cards: [
        {
          ...
          body: "Article 5: The people of Kurdistan include Kurds, Turkmen, Arabs, Chaldeans, Syriacs, Assyrians, and Armenians. Article 16: Religion is not compulsory — freedom of belief is guaranteed for all.",
          icon: eu,
          accent: "#52235f",
        },
        {
          ...
          body: "Article 20: Equality before the law. No discrimination based on origin, color, ethnicity, language, religion, or belief. Violators are punished under applicable laws.",
          icon: lo,
          accent: "#7a4a12",
        },
        {
          ...
          body: "Turkmen, Syriac, and Armenian are official languages in their areas alongside Kurdish. All communities have the right to media in their own language.",
          icon: au,
          accent: "#16466b",
        },
        {
          ...
          body: "Established by the Ministry of Endowments and Religious Affairs to deepen relationships among all religious and ethnic groups in the Kurdistan Region.",
          icon: ao,
          accent: "#244b1f",
        },
      ],
      ...
      cards: [
        {
          ...
          body: "ISIS committed genocide against Yazidis in Sinjar — mass executions, forced displacement, and enslavement. August 3 was officially recognized as Yazidi Genocide Day by the Kurdistan Parliament.",
          icon: du,
          accent: "#6b1d1d",
        },
        {
          ...
          body: "Christians, Turkmen, and others were forced to flee. The Kurdistan Region became their refuge and safe haven when nowhere else was safe.",
          icon: fu,
          accent: "#7a4a12",
        },
        {
          ...
          body: "Played a vital role in halting ISIS, protecting minority communities, and liberating key areas including Sinjar and Kirkuk in cooperation with international coalition forces.",
          icon: cu,
          accent: "#244b1f",
        },
        {
          ...
          body: "The KRG housed, fed, and protected displaced communities. The Patriarch of the Assyrian Church expressed gratitude to the KRG for hosting over one and a half million refugees.",
          icon: iu,
          accent: "#52235f",
        },
      ],
      tagline:
        "The Kurdistan Region did not close its doors. It opened them wider.",
    },
    ku: {
      back: "گەڕانەوە",
