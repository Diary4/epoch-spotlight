    ...
    <main dir={dir} className={FAITH_MAIN_CLASS}>
      <section ref={sectionRef} className={FAITH_SECTION_CLASS}>
        <FaithDetailHeroVideo
          ...
          src={waterVideo}
          desktopClassName="absolute inset-0 h-[80vh] w-full object-cover [mask-image:linear-gradient(to_bottom,black_0%,black_70%,transparent_100%)]"
        >
        ...
        <div className={`relative z-10 mx-auto max-w-[1120px] ${FAITH_CONTENT_PADDING}`}>
          ...
          >
            ...
            <h1 className="break-words font-serif text-[clamp(28px,8vw,88px)] font-semibold uppercase leading-[1] tracking-[0.12em] text-[#2f1f12] sm:text-[68px] lg:text-[88px]">
              {c.title}
            </h1>
          ...
          <FaithDetailSpacer desktopHeight="h-[780px]" />
