    ...
    <ReligionsScaledPage dir={dir} lang={lang} fitDeps={[lang]} sectionRef={sectionRef} className="px-12 pb-14">
      ...
      <div className="relative z-10 mx-auto max-w-[1080px]">
        ...
        >
          ...
          <p className="mt-4 font-serif text-[30px] font-semibold text-[#a46f22]">
            {pageSubtitle}
          </p>
        ...
        >
          <div className="absolute left-[235px] top-0 h-full w-px bg-[#c3923a]/55" />
            ...
            {localizedTimeline.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="grid h-[115px] place-items-center rounded-xl border border-[#d8b875]/35 bg-[#fff4dc]/35 p-4 text-[#c3923a]/45">
          ...
          <div className="grid grid-cols-6 gap-5">
            {localizedThreads.map((item) => {
              ...
              return (
                <article
                  key={item.title}
                  className="border-[#d8b875]/45 text-center border-r last:border-r-0"
                >
                  <Icon
