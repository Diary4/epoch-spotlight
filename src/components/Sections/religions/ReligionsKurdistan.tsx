    ...
    <ReligionsScaledPage dir={dir} lang={lang} fitDeps={[lang]} sectionRef={sectionRef} className="px-12 pb-14">
      ...
      <div className="relative z-10 mx-auto max-w-[1120px]">
        ...
        >
          ...
          <h1 className="font-serif text-[92px] font-semibold uppercase leading-[1.02] tracking-[0.08em] text-[#2f1f12]">
          ...
          <p className="mt-5 font-serif text-[31px] font-semibold text-[#a46f22]">
            {pageSubtitle}
          </p>
        ...
        <section
          data-religion-animate="true"
          className="mt-[420px] grid grid-cols-4 gap-6"
        >
