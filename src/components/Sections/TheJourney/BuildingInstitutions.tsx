      ...
      >
        <main ref={rootRef} className="m-0 h-full w-full bg-[#fbf5eb] text-[#17233b]">
          <section className="relative mx-auto flex h-full w-full flex-col overflow-hidden bg-[#fbf5eb] px-[clamp(1.2rem,4cqw,4rem)] py-[clamp(1.2rem,3.6cqh,3.8rem)]">
            ...
            <div className="journey-detail-hero pointer-events-none absolute left-0 top-0 h-[min(88cqh,1260px)] w-full overflow-hidden rtl:left-auto rtl:right-0">
              <div className="absolute inset-0">
                <img
                  src={bg}
                  alt="Building institutions in Kurdistan"
                  className={`h-full w-full object-cover object-[center_38%] ${dir === "rtl" ? "-scale-x-100" : ""}`}
                />
              </div>
              <div className="pointer-events-none absolute inset-y-0 right-0 w-[48%] bg-gradient-to-l from-[#fbf5eb] from-0% via-[#fbf5eb] via-42% to-transparent to-100% rtl:right-auto rtl:left-0 rtl:bg-gradient-to-r" />
              <div className="pointer-events-none absolute inset-x-0 bottom-0 h-[clamp(4rem,10cqh,8rem)] bg-gradient-to-t from-[#fbf5eb] from-0% via-[#fbf5eb]/40 via-50% to-transparent to-100%" />
            </div>

            <div className="relative z-10 flex flex-1 flex-col">
              {/* Hero text */}
              <section className="journey-detail-intro ml-auto max-w-[min(46cqw,740px)] pt-[clamp(2.5rem,7cqh,6rem)] text-right rtl:text-right">
                ...
                <div className="mt-[clamp(1rem,2.3cqh,2rem)] ml-auto flex w-[clamp(9rem,18cqw,14.5rem)] items-center gap-4 text-[#b99152]">
                  <span className="h-0.5 flex-1 bg-[#b99152]" />
                  <span className="h-3 w-3 rotate-45 border-2 border-[#b99152]" />
                  <span className="h-0.5 flex-1 bg-[#b99152]" />
                </div>

                <p className="mt-[clamp(1rem,2.4cqh,2rem)] ml-auto max-w-[min(37cqw,560px)] text-[clamp(1.12rem,1.85cqw,1.85rem)] font-light leading-[1.48] text-[#17233b]">
