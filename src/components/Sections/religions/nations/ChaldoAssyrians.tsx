...
import heroBg from "@/assets/images/religions/nations/assriyan.webp";
import languageImg from "@/assets/images/religions/nations/assyrian/syriac-language.jpeg";
import ankawaImg from "@/assets/images/religions/nations/assyrian/ankawa.webp";
import patriarchImg from "@/assets/images/religions/nations/assyrian/patriah.webp";
import parliamentImg from "@/assets/images/religions/nations/assyrian/seat.webp";
import {
    ...
    <FaithDetailPageShell dir={dir} lang={lang} fitDeps={[lang]} sectionRef={sectionRef}>
      ...
      >
        <header
          ...
          className="mx-auto max-w-[850px] translate-x-[260px] pt-[100px] text-center"
        >
          <div className="mx-auto mb-2 w-[220px]">
            <DecorativeLine color="#e8c56a" />
          </div>
          <h1 className="break-words font-serif text-[84px] font-light uppercase leading-[1.02] tracking-[0.04em] text-[#faf6ee] drop-shadow-[0_2px_18px_rgba(0,0,0,0.85)]">
            {c.pageTitle}
          </h1>
          ...
          <p
            className="mx-auto mt-4 max-w-[640px] font-serif text-[24px] font-normal leading-relaxed text-white"
