    ...
    slides: [
      {
        ...
        subtitle: "A Place Where the Persecuted Have Always Found Peace",
        cards: [
          {
            id: "ancient-roots",
            number: 1,
            title: "Ancient Roots",
            body: "Religions such as Mithraism, Judaism, Zoroastrianism, Christianity, Yazidism, and Islam have flourished here since the dawn of history.",
            icon: Mountain,
            accent: "#7a4a12",
          },
          {
            ...
            body: "Jews settled in Kurdistan in the 6th century BCE and remained here because they found a rare spirit of tolerance among the Kurdish people.",
            icon: Star,
            accent: "#2a3550",
          },
          {
            ...
            number: 3,
            title: "Christians",
            body: "Christianity reached Erbil in the 1st century CE through Addai and Mari. By the 3rd century, Erbil had become a major center of Christianity.",
            icon: Cross,
            accent: "#244b1f",
          },
          {
        ...
        tagline:
          "Stability and peace have made Kurdistan a safe haven throughout the ages.",
      },
    ],
  },
  ku: {
