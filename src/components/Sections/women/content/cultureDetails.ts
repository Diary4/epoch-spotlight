import { arCultureDetails } from "@/components/Sections/women/content/arWomenContentData";
...
export const cultureDetailsByLang = {
  en: {
    "eyse-san": {
      ...
      metaLine: "1938 – December 18, 1996 | Amed, Northern Kurdistan",
      intro:
        "Eyşe Şan was one of the most powerful Kurdish voices of the twentieth century. Born into a musical family, she faced deep social pressure at a time when many believed singing was not acceptable for women. Her life was marked by hardship, separation, exile, and personal tragedy, yet her voice became a symbol of Kurdish sorrow, dignity, and resistance. During years when the Kurdish language was heavily restricted, Eyşe Şan carried Kurdish identity through song.",
