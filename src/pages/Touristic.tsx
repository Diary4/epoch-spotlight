...
const NaturalPlaces = () => {
  ...
  return (
    <main className="min-h-screen w-screen overflow-x-hidden bg-[#faf8f5] text-stone-800">
      <section className="relative mx-auto min-h-screen w-full bg-[#faf8f5]">
        ...
        <header className="relative z-30 flex items-center justify-between gap-4 px-6 pb-12 pt-8 sm:px-10 lg:px-14">
          <div className="min-w-0">
            <p className="text-[11px] uppercase tracking-[0.38em] text-[#d6a45b] font-semibold">
              Kurdistan
            </p>
            <h1 className="mt-2 font-serif text-3xl uppercase tracking-[0.2em] text-stone-900 sm:text-4xl">
        ...
        <div ref={containerRef} className="relative z-20 w-full max-w-6xl mx-auto px-6 pb-24">
          ...
          <div className="absolute left-8 md:left-1/2 top-4 bottom-4 w-0.5 bg-gradient-to-b from-[#d6a45b]/10 via-[#d6a45b]/35 to-[#d6a45b]/10 -translate-x-1/2" />
                  ...
                  >
                    ...
                    >
                      {isEven ? (
                        ...
                        <div className="relative w-full h-[280px] lg:h-[340px] overflow-hidden rounded-xl border border-stone-200 transition duration-500 group-hover:border-[#c89b52]/40">
                          <img
                            src={place.image}
                            alt={place.name}
