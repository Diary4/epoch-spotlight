...
const WORK_ONLY_KU =
  "یەکێکە لەو وڵاتانەی کە کاری مرۆڤ دۆستانەی دەزگای خێرخوازی بارزانی لە ماوەی بیست ساڵی ڕابردوودا گەیشتووەتێ.";
const WORK_ONLY_AR =
...
const projectsAr: ProjectsCopy = {
  ...
  sectorLabel: "قطاع",
  entriesLabel: "النماذج المختارة",
  entryLabel: "نموذج مختار",
  entriesShort: "نماذج",
  yearsLabel: "السنوات الموثّقة",
  timelineTitle: "نماذج مختارة من التقارير",
  beyondTitle: "خارج كوردستان",
  beyondSubtitle: "أعمال المؤسسة خارج كوردستان.",
  ...
  scopeNote: "النطاق",
  sourceNote:
    "الأرقام مستمدة من السجلات الموثقة، وقد يتكرر احتساب بعض المستفيدين بين الأنشطة أو السنوات.",
};
...
export const bcfCopy: Record<BcfLang, BcfCopy> = {
  ...
  ku: {
    ...
    enterHint: "دەست لە هەر شوێنێک بدە",
    home: "سەرەتا",
    language: "زمان",
    donate: "بەخشین",
    donateTitle: "بەخشین بۆ دەزگای خێرخوازی بارزانی",
    donateHint: "ئەم کۆدە بە مۆبایلەکەت سکان بکە بۆ کردنەوەی پەڕەی بەخشینی دەزگای خێرخوازی بارزانی.",
    ...
    welcomeTitleBcf: "دەزگای خێرخوازی بارزانی",
    ...
    serveCategories: [
      {
        ...
        title: "ئاسایشی خۆراک",
        intro:
          "ئاسایشی خۆراک یەکێکە لە سێکتەرە مرۆییە سەرەکییەکانی دەزگای خێرخوازی بارزانی. هاوکاری خۆراکی پێشکەش بە خێزانە لێقەوماوەکان، ئاوارەکان، پەنابەران و ئەو کۆمەڵگایانە دەکرێت کە بەهۆی قەیرانەکانەوە زیانیان پێگەیشتووە.",
        beneficiaries: {
          families: "3,550,152",
          individuals: "19,332,863",
        },
        headline:
          "پشتگیری خۆراک زیاترە لە تەنها ژەمێک: سەقامگیرییە لە کاتی نادڵنیایی، کەرامەتە لە کاتی سەختی، و ئومێدە لە کاتی قەیراندا.",
        groups: [
          {
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی پشتگیری خزمەتگوزارییە تەندروستییەکان بۆ کۆمەڵگە کەمدەرامەت و نەدارەکان دەکات، لە ڕێگەی پڕۆژەی پزیشکی، پشتگیریکردنی بنکە و دامەزراوەکان و پڕۆگرامەکانی چارەسەرکردنەوە.",
        beneficiaries: {
          individuals: "3,318,211",
        },
        headline:
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی وەبەرهێنان لە کەرتی پەروەردەدا دەکات، چونکە فێربوون یەکێکە لە بەهێزترین ڕێگاکان بۆ ڕزگاربوون لە هەژاری و نەداری.",
        beneficiaries: {
          individuals: "707,700",
        },
        headline:
      ...
      },
      {
        ...
        intro:
          "کاری دەزگای خێرخوازی بارزانی لە کەرتی ئاو، ئاوەڕۆ و پاکوخاوێنیدا سەرنج دەخاتە سەر دابینکردنی ئاوی خاوێن، خزمەتگوزارییەکانی ئاوەڕۆ و پاکوخاوێنی.",
        beneficiaries: {
          families: "834,827",
          individuals: "4,145,402",
        },
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی حەوانەوە و فریاگوزاری خێرا پێشکەش بە خێزانە ئاوارەکان و ئەو کۆمەڵگایانە دەکات کە بەهۆی شەڕ، قەیران و کارەساتی سروشتییەوە زیانیان بەرکەوتووە.",
        beneficiaries: {
          families: "39,587",
          individuals: "190,664",
        },
        ...
        groups: [
          {
            ...
            items: [
              "دروستکردنی ٤٠٠ کاروان لە ڤان، تورکیا، لە ساڵانی ٢٠١١–٢٠١٢",
              "دروستکردنی ٣٠٠ کاروان لە کامپی بەحرکە لە ساڵی ٢٠١٥",
              "دروستکردنی ٦٠٠ کاروان لە کامپی دەرکار عەجەم لە ساڵی ٢٠١٦",
      ...
      },
      {
        ...
        intro:
          "کاری دەزگای خێرخوازی بارزانی لە کەرتی پاراستندا سەرنج دەخاتە سەر سەلامەتی، کەرامەت و خۆشگوزەرانی خەڵکی کەمدەرامەت و بێدارەکان.",
        beneficiaries: {
          individuals: "397,830",
        },
        headline:
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی پشتگیری کەسانی خاوەن پێداویستی تایبەت، منداڵانی ئۆتیزم و ئەو کۆمەڵگایانە دەکات کە بەدەست تەحەددییاتە تەندروستی و کۆمەڵایەتییەکانەوە دەناڵێنن.",
        headline:
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی پشتگیری پڕۆژەکانی بژێوی ژیان دەکات کە یارمەتی تاکەکان و خێزانەکان دەدەن بۆ ئەوەی زیاتر پشت بە خۆیان ببەستن.",
        beneficiaries: {
          families: "56,929",
          individuals: "428,122",
        },
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی بەڕێوەبردن و پشتگیریکردنی ئەو کامپانە دەکات کە خزمەتگوزاری بە پەنابەران و ئاوارە ناوخۆییەکان پێشکەش دەکەن.",
        beneficiaries: {
          families: "4,531,250",
          individuals: "22,679,526",
        },
        ...
        groups: [
          {
            ...
            items: [
              ...
              "چاککردنەوە و ڕاگرتنی خێمە و کاروانەکان",
      ...
      },
      {
        ...
        intro:
          "دەزگای خێرخوازی بارزانی پاڵپشتی دارایی ڕاستەوخۆ پێشکەش بەو خێزانانە دەکات کە پێویستیان بە یارمەتی بەپەلە هەیە بۆ دابینکردنی پێداویستییە سەرەکییەکانی ژیان.",
        beneficiaries: {
          families: "37,121",
          individuals: "338,767",
        },
      ...
      },
      {
        ...
        intro:
          "ئاڕاستەی داهاتووی دەزگای خێرخوازی بارزانی پاراستنی ژینگە و هۆشیاری سەبارەت بە کەشوهەوا لەخۆ دەگرێت.",
        headline:
        ...
        groups: [
          {
            ...
            items: [
              ...
              "کەمکردنەوەی بەکارهێنانی پلاستیک بە ڕێژەی ٨٠٪ لە نووسینگەکانی دەزگای خێرخوازی بارزانیدا",
    ...
    whoHowHint:
      "دەزگای خێرخوازی بارزانی لە سەرانسەری سێکتەرە مرۆییە سەرەکییەکاندا کار دەکات بۆ دابینکردنی پێداویستییە بەپەلەکان و پاڵپشتیکردنی چاکبوونەوەی درێژخایەن.",
    whoServesItems: [
    ...
    storySections: [
      {
        ...
        body: "دەزگای خێرخوازی بارزانی بە شێوەیەکی فەرمی لە ساڵی ٢٠٠٥ لە هەولێری پایتەختی هەرێمی کوردستانی عێراق دامەزرا، بۆ گۆڕینی بەزەیی و هاوسۆزی بە کارێکی مرۆیی ڕێکخراو.",
      },
      {
        id: "timeline",
        titleGold: "هێڵی کاتی",
      ...
      },
      {
        ...
        titleGold: "پەیام",
        titleWhite: "",
        body: "پێشکەشکردنی هاوکاری مرۆیی بە لێقەوماوان، بەبێ جیاکاری لەسەر بنەمای بنچینەی نەتەوەیی، ئاینی یان سیاسی، لەگەڵ بەرقەرارکردنی ئاشتی و کەرامەت بۆ مرۆڤایەتی و سروشت.",
      },
      {
        id: "vision",
        titleGold: "دیدگا",
    ...
    storyMilestones: [
      ...
      },
      {
        ...
        body: "مۆڵەتی کۆمیسیۆنی خێرخوازی بەریتانیا و بەڕێوەبردنی کەمپەکان لە دهۆک.",
      },
      {
        id: "autism",
        year: "2021",
    ...
    globalLocations: {
      ...
      unitedKingdom: {
        ...
        facts: ["کەرت: هاوکاری پارەیی"],
      },
      unitedStates: {
        name: "ویلایەتە یەکگرتووەکانی ئەمریکا",
        meta: "مۆڵەتدار",
        description:
          "لە ویلایەتە یەکگرتووەکان تۆمار کراوە بۆ کارکردن، کە هاوبەشی ڕوون و پشتگیری مرۆیی بەرپرسیارانەی نێودەوڵەتی دەستەبەر دەکات.",
        facts: [
      ...
      turkiye: {
        ...
        facts: [
          "٦ کەرت: خۆراک، کەلوپەلی ناخۆراکی، پەناگە، هاوکاری پارەیی، ئاو و خاوێنکاری، تەندروستی",
        ],
      },
      syria: {
        name: "سووریا",
        ...
        facts: [
          "٩ کەرت: خۆراک، ئاو و خاوێنکاری، پاراستن، هاوکاری دارایی تەندروستی، پەناگە، پەروەردە، بژێوی، کەلوپەلی ناخۆراکی",
        ],
      },
      ukraine: {
        name: "ئۆکرانیا",
      ...
      lebanon: {
        ...
        facts: ["کەرتەکان: هاوکاری دارایی ، خۆراک"],
      },
      morocco: {
        name: "مەغریب",
        meta: "٢ کەرت",
    ...
    locations: {
      erbil: {
        ...
        short: "هەولێر",
        description:
          "پارێزگای سەرەکیی دەزگای خێرخوازی بارزانی و فراوانترین ناوچەی کارەکانی دامەزراوەکەیە؛ پڕۆژەکانی خۆراک، قوتابخانە، ئاو، کەمپ، نیشتەجێکردن و ناوەندی لێهاتوویی بۆ چاودێری ئاڵۆز لەخۆدەگرێت.",
      ...
      duhok: {
        ...
        short: "دهۆک",
        description:
          "لە ساڵی ٢٠٢١دا ژمارەی کەمپەکان لە بەرزترین ئاستدا گەیشتە ٢٠ کەمپ؛ هەروەها پڕۆژەی نیشتەجێبوونی ڕۆژ سیتی بە ٤٢٠ یەکەی نیشتەجێبوون جێبەجێ کرا، و لە ساڵی ٢٠٢٦دا نانەواخانەکانی نانی خۆڕایی لە ناوچە جیاوازەکاندا بەردەوامن لە کارکردن.",
        explore: "پڕۆژەکان ببینە",
      },
      sulaymaniyah: {
        name: "سلێمانی",
        short: "سلێمانی",
        description:
          "لە بەرنامەی نۆژەنکردنەوەی ٢٠٣ قوتابخانەدا، ٥٠ قوتابخانە نۆژەن کرانەوە؛ هەروەها پڕۆژەکانی گۆشتی قوربانی و خۆراکی ڕەمەزان بەردەوام بوون، و لە ساڵی ٢٠٢٦دا لە ڕێگەی ئۆفیسەکەوە یارمەتی دارایی بۆ خێزانەکان دابەش کرا.",
        explore: "پڕۆژەکان ببینە",
      },
      kirkuk: {
        name: "کەرکوک",
        short: "کەرکوک",
        description:
          "لە بەرنامەی نۆژەنکردنەوەی ٢٠٣ قوتابخانەدا، کەرکووک زۆرترین بەشی هەبوو؛ هەروەها پڕۆژەکانی خۆراک، یارمەتی کەسانی خاوەن پێداویستی تایبەت و پێکەوەژیان لە پارێزگاکە جێبەجێ کران.",
        explore: "پڕۆژەکان ببینە",
      },
      nineveh: {
        name: "نەینەوا / مووسڵ",
        short: "مووسڵ",
        description:
          "نزیکەی نیو ملیۆن ژەم خواردنی گەرم لە ساڵی ٢٠٢٢ دابەش کرا، ١٠ کەمپ بەڕێوەدەبران، هەروەها نەخۆشان لە کەمپەکانی ڕۆژهەڵاتی موسڵ بۆ نەخۆشخانەکانی هەولێر و موسڵ گواسترایەوە.",
        explore: "پڕۆژەکان ببینە",
      },
      sinjar: {
        name: "شنگال",
        short: "شنگال",
        description:
          "ئەو شوێنەی کاری فریاکەوتنی دەزگای خێرخوازی بارزانی لێرە دەستی پێکرد؛ وەڵامدانەوە بە تەقینەوەکانی ساڵی ٢٠٠٧، گەیاندنی یارمەتی بە هەلیکۆپتەر بۆ چیا لە ساڵی ٢٠١٤، و ئەو خانووانەی لەوێ لەو کاتەوە دروست کراون.",
        explore: "پڕۆژەکان ببینە",
      },
      garmian: {
        name: "گەرمیان / کەلار",
        short: "گەرمیان",
        description:
          "پڕۆژەکانی خۆراک، یارمەتی کەسانی خاوەن پێداویستی تایبەت و یارمەتی دارایی لە کەلار، کفری، خانەقین، ڕزگاری و دەربەندیخان جێبەجێ کران؛ هەروەها لە ساڵی ٢٠٢٤دا یارمەتی بۆ خێزانە زیانلێکەوتووەکانی لافاو دابەش کرا.",
        explore: "پڕۆژەکان ببینە",
      },
      halabja: {
        name: "هەڵەبجە",
      ...
      raparin: {
        ...
        short: "ڕاپەڕین",
        description:
          "ئۆفیسی ڕاپەڕینی دەزگای خێرخوازی بارزانی — پڕۆژەکانی خۆراک، تەندروستی و کۆمەڵایەتی لە ساڵی ٢٠٠٧ تا ٢٠١٩ تۆمار کراون.",
        explore: "پڕۆژەکان ببینە",
      },
      soran: {
        name: "سۆران",
        short: "سۆران",
        description:
          "پێنج قوتابخانە نۆژەن کرانەوە، بەشێک لە خانووەکانی پڕۆژەی شەهیدان دابەش کران، هەروەها لە ناوەندی کۆمەڵایەتی دایک چالاکی هۆشیارکردنەوە دەربارەی ئۆتیزم جێبەجێ کرا.",
        explore: "پڕۆژەکان ببینە",
      },
      zakho: {
        name: "زاخۆ",
        short: "زاخۆ",
        description:
          "سۆپای زستانە و وەڵامدانەوەی لافاو لەسەر سنوور، پڕۆژەیەکی خوێندەواری پێنج مانگە بۆ منداڵانی پەنابەر، و فەرشی مزگەوتەکان لە سەرانسەری ئیدارەدا.",
        explore: "پڕۆژەکان ببینە",
      },
      akre: {
        name: "ئاکرێ",
        short: "ئاکرێ",
        description:
          "بەستە خۆراکییەکان بۆ دانیشتوانی کەمپەکان بە هاوکاری کاریتاسی ئەڵمانی دابەش کران. لە ساڵی ٢٠٢١دا ١٠,٠٠٠ نەمامی دار بەڕوو چێندران. هەروەها نەخۆشخانەی دایک و منداڵ نوێکرایەوە و ئەم کارە لە ڕاپۆرتی گشتی کۆکراوەدا تۆمار کراوە.",
        explore: "پڕۆژەکان ببینە",
      },
      amedi: {
        ...
        short: "ئامێدی",
        description:
          "ناوەندی زەردەخەنە بە هاوکاری کاریتاسی ئەڵمانیا، خزمەتگوزاری چاودێری تایبەت و چالاکییەکانی هۆشیارکردنەوەی ئۆتیزمی پێشکەش کرد؛ هەروەها سەبەتەی خۆراک لە شارۆچکەکانی ناوچە شاخاوییەکان دابەش کران.",
        explore: "پڕۆژەکان ببینە",
      },
      rojava: {
        ...
        short: "ڕۆژئاوا",
        description:
          "گەورەترین کاری ئێستای دەزگای خێرخوازی بارزانی لە دەرەوەی سنوور — ٤١٥ بارهەڵگر، ٢٩٬٠٧٠ خێزان، ئارد بۆ ٣٫٣٦ ملیۆن نان، گازۆیل، دەرمان و کار — لەگەڵ بەرنامەی چەسپاوی عەفرین: کلینیکی گەڕۆک، ناوەندی کولتوور و گەشەپێدانی بارزانی، پشتگیری خوێندکاران و ١٩٢ ئازیزانی سەرپەرشتیکراو.",
        explore: "پڕۆژەکان ببینە",
      },
      iraq: {
      ...
      syria: {
        ...
        short: "سووریا",
        description:
          "لێرەدا وەڵامدانەوەی بوومەلەرزە و بەرنامەی عەفرین کاری دەزگای خێرخوازی بارزانی فراوان کرد، و ئێستا کاری ڕۆژئاوای کوردستان لێرەدا بەڕێوەدەچێت.",
        explore: "پڕۆژەکان ببینە",
      },
      lebanon: {
        name: "لوبنان",
    ...
    boardChief: {
      ...
      meta: "دەزگای خێرخوازی بارزانی",
      intro:
        "بۆردی دامەزرێنەران باڵاترین دەسەڵاتە لە دەزگادا. سەرۆک ئەو بنەما و پێوەرانە دادەنێت کە کارکردنی پێ هەڵدەسەنگێندرێت کە ئەمەش لەسەر بنەمای پێویستی دەدرێت، و بە شێوەیەک پێشکەش دەکرێت کە کەرامەتی ئەو کەسە بپارێزێت کە وەریدەگرێت.",
      slides: [
        {
          id: "honour",
          caption:
      ...
      timelineMilestones: [
        {
          ...
          year: "١٩٦٩",
          title: "ڕەگ و ڕیشە",
          body: "ڕێزدار مەسرور بارزانی لە ١٩٦٩دا لەدایک بووە و ساڵانی سەرەتای ژیانی لە قۆناغێکی گرنگ و چارەنووسساز لە مێژووی کورددا بووە، منداڵی و سەرەتای گەنجێتی بە ئاوارەیی ، خوێندن و هەستکردن بە بەرپرسیارێتی و  خزمەتکردن بە نەتەوەیەک کە لە ناو خەباتدا ابەڕێکردووە.",
        },
        {
          id: "youth",
          year: "١٩٨٥",
          title: "لە گەنجییەوە بۆ خەبات",
          body: "لە ساڵی ١٩٨٥، کاتێک تەنها ١٦ ساڵ بوو، ڕێزدار مەسرور بارزانی پەیوەندی بە هێزی پێشمەرگەی کوردستانەوە کرد. خزمەتکردنی لە تەمەنی گەنجیدا وای کرد بە شێوەیەکی ڕاستەوخۆ بەشداری خەباتی کورد بێت، لە یەکێک لە سەختترین قۆناغەکانی مێژووی ئەو خەباتەدا.",
        },
        {
          id: "education",
          year: "١٩٩٣",
          title: "خوێندن لە دەرەوەی وڵات",
          body: "دوای ئەو ساڵانەی کە ژیانی بە ملمڵانێ و خەبات تێپەڕی،ڕێزدار مەسرور بارزانی بۆ بەردەوامبوون لە خوێندنی باڵا چووە دەرەوەی وڵات. لەوێ زانیاری و تێگەیشتنی خۆی لەبارەی پەیوەندییە نێودەوڵەتییەکان، ئاشتی و چارەسەرکردنی ناکۆکییەکان زیاتر پەرەپێدا.",
        },
        {
          id: "security",
          year: "١٩٩٨",
          title: "ئاسایش و دامەزراندنی دەوڵەت",
          body: "دوای گەڕانەوەی بۆ کوردستان لە ساڵی ١٩٩٨، ڕێزدار مەسرور بارزانی بەرپرسیارێتییە باڵاکانی لە دامەزراوە سیاسی و ئاسایشییەکاندا گرتە ئەستۆ. دواتر بوو بە ڕاوێژکاری ئەنجومەنی ئاسایشی هەرێمی کوردستان.",
        },
        {
          id: "service",
          year: "٢٠٠٥",
          title: "خزمەت لە دەرەوەی حکومەت",
          body: "ڕێزدار مەسرور بارزانی تەنها بە بواری حکومەت سنووردار نەبوو، بەڵکو بواری مرۆیی و ئەکادیمیشی گرتەوە. لەوانە دامەزراندنی دەزگای خێرخوازی بارزانی و پشتگیری لە خوێندنی باڵا لە کوردستان.",
        },
        {
          id: "cabinet",
          year: "٢٠١٩",
          title: "سەرۆک وەزیران — کابینەی نۆیەم",
          body: "لە ٢٠١٩دا، مەسرور بارزانی وەک سەرۆک وەزیرانی هەرێمی کوردستان هەلبژێردرا بۆ پێکهێنانی کابینەی نۆیەمی حکومەتی هەرێمی کوردستان",
        },
      ],
    },
    bcfPresident: {
      ...
      meta: "دەزگای خێرخوازی بارزانی",
      bioLabel: "ژیاننامە",
      bio: "لە ٥ی ئابی ١٩٧٤ لە گوندی کەلۆک لە ناوچەی بارزان لە دایک بووە و دەرچووی پەیمانگای هونەرە جوانەکانە. لە تەمەنێکی زووەوە دەستی بە خزمەتکردن لە بواری گشتی و مرۆیی کرد.",
      journeyLabel: "دەستپێکی ڕێگا",
      journey: [
        {
          id: "students",
          period: "١٩٩٤ – ١٩٩٨",
          body: "وەک سکرتێری یەکێتی قوتابیانی کوردستان خزمەتی کرد.",
        },
        {
          id: "bcf",
          period: "٢٠٠٧",
          body: "وەک جێگری سەرۆک پەیوەندی بە ڕێبەرایەتی دەزگای خێرخوازی بارزانییەوە کرد و دواتر بوو بە سەرۆکی دەزگاکە.",
        },
        {
          id: "tenure",
          period: "زیاتر لە ١٩ ساڵ",
          body: "بەشدارییەکی گرنگی لە بەڕێوەبردنی ئامانجە مرۆییەکانی دەزگاکە و فراوانکردنی یارمەتی بۆ کۆمەڵگا پێویستەکاندا هەبووە.",
        },
      ],
    ...
    bcfFounder: {
      ...
      roles: [
        {
          id: "politburo",
          title: "مەکتەبی سیاسی پارتی دیموکراتی کوردستان",
          body: "ئەندامی مەکتەبی سیاسی و دەستەی جێبەجێکاری پارتی دیموکراتی کوردستان.",
        },
        {
          id: "envoy",
          title: "نێردراوی تایبەت",
          body: "نێردراوی تایبەتی سەرۆک مەسعود بارزانی.",
        },
        {
          id: "bureau",
          title: "لێپرسراوی ئۆفیسی تایبەتی سەرۆک",
          body: "ڕۆڵی لە بەڕێوەبردنی پەیوەندییەکان و ڕێکخستنی دیدارەکانی سەرۆک بارزانی لەگەڵ شاند و کەسایەتییەکاندا هەیە.",
        },
      ],
      serviceLabel: "خەباتی پێشمەرگایەتی",
      serviceIntro: "لە کۆتایی ساڵانی ١٩٧٠دا پەیوەندی بە هێزی پێشمەرگەوە کرد.",
      service: [
        {
          id: "gulan",
          title: "شۆڕشی گوڵان",
          body: "لە شۆڕشی گولاندا خزمەتی کرد و لە دابینکردن و گواستنەوەی پێداویستییەکانی خەبات لە شاخدا بەشداری هەبوو. هەروەها بە وێنە، ڕووداو و چالاکییەکانی شۆڕشی تۆمار کرد.",
        },
      ],
      partyLabel: "ڕزگارکردن و بەرگری",
      party: [
        {
          id: "uprising",
          title: "ڕاپەڕینی ئاداری ١٩٩١",
          body: "بەشداری لە ڕاپەڕینی ئاداری ساڵی ١٩٩١ کرد.",
        },
        {
          id: "isis",
          title: "شەڕ لە دژی داعش",
          body: "لە بەرەکانی پێشەوەدا بەردەوام ڕۆڵی ڕێبەرایەتی و سەرپەرشتی هەبوو",
        },
      ],
    },
    trustQualityTitle: "کوالێتی و باوەڕپێکراوی",
    trustCredentials: [
      {
        id: "krg",
    ...
    futureCircle: "داهاتوو بنیاد دەنێین",
    legacyCircle: "میراتێک کە بەردەوامە",
    legacyTitleWhite: "میراتێک",
    legacyTitleGold: "کە بەردەوامە",
    legacyLead:
      "دەزگای خێرخوازی بارزانی کە ڕەگی لە ناو خاکی کوردستاندایە و بەو باوەڕەوە هەنگاو دەنێت کە خزمەتکردن شانازییە، بەردەوامە لە پشتگیریکردنی کۆمەڵگا نەدار و کەمدەرامەتەکان لە ڕێگەی بەزەیی، کەرامەت و کارە مرۆییە پیشەییەکانەوە.",
    legacyBridge:
      "لە دابینکردنی خۆراک و پەناگە تا دەگاتە پەروەردە، تەندروستی، پاراستن، ڕاهێنان و بەرپرسیارێتی ژینگەیی، دەزگای خێرخوازی بارزانی پەیامێک هەڵدەگرێت کە دەگاتە دەرەوەی سنوورەکان:",
    legacyPillars: [
    ...
    legacyThanks: "سوپاس",
    legacyThanksBody: "سوپاس بۆ سەردانیکردنی دەزگای خێرخوازی بارزانی.",
    legacyRestart: "گەڕانەوە بۆ سەرەتا",
    futureHeadingWhite: "داهاتوو",
    futureHeadingGold: "بنیاد دەنێین",
    futureHeadingRest: "",
    futureSubtitle:
    ...
    futureTopics: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "پەرەپێدانی بەرنامەکانی بژێوی سەوز",
        ],
      },
      {
        id: "crises",
        title: "ئامادەکاری بۆ قەیران",
        bullets: [
          "بەهێزکردنی توانای وەڵامدانەوەی فریاگوزاری",
          "ئامادەکردنی یارمەتییەکان لە ڕێگەی ڕێڕەوە سەرەکییەکان",
          "ڕاهێنانی تیمەکانی فریاکەوتنی خێرا",
        ],
      },
      {
        id: "rehabilitation",
        ...
        bullets: [
          "نۆژەنکردنەوەی خانوو و شوێنە گشتییەکان",
          "فراوانکردنی خزمەتگوزارییە گشتییەکان بۆ خاوەن پێداویستییە تایبەتەکان",
          "پشتگیریکردنی ئاوەدانکردنەوە و پێکەوەژیان",
        ],
      },
      {
        id: "rights",
        title: "مافی مرۆڤ و بوژانەوە",
        bullets: [
          "پاراستنی کەرامەتی مرۆڤ لە سەرجەم پڕۆگرامەکاندا",
          "پشتگیریکردنی ڕزگاربووان",
          "پەرەپێدانی دەستگەیشتنی دادپەروەرانە بە خزمەتگوزارییەکان",
        ],
      },
    ],
    projects: projectsKu,
  ...
  ar: {
    ...
    iraqPlaces: {
      ...
      diyala: {
        name: "ديالى",
        short: "ديالى",
        note: "مساعدات مباشرة موثّقة في الغذاء والتعليم والإغاثة الأسرية ودعم ذوي الهمم.",
      },
      anbar: {
        name: "الأنبار",
        short: "الأنبار",
    ...
    locations: {
      erbil: {
        ...
        short: "أربيل",
        description:
          "تجمع أربيل، حيث يقع المقر الرئيس للمؤسسة، بين الاستجابة الطارئة والخدمات المستدامة في الغذاء والصحة والتعليم والمأوى والمياه وإدارة المخيمات ودعم ذوي الهمم والأعزاء.",
      ...
      duhok: {
        ...
        short: "دهوك",
        description:
          "يشمل سجل دهوك دعم اللاجئين وعمليات المخيمات والغذاء والصحة والتعليم والمياه ومساعدة ذوي الهمم ودعم الأعزاء وأحد أكبر برامج الإسكان لدى مؤسسة بارزاني الخيرية.",
        explore: "استكشف المشاريع",
      },
      sulaymaniyah: {
        name: "السليمانية",
        short: "السليمانية",
        description:
          "يشكل الغذاء والتعليم والصحة والإغاثة الأسرية والمياه ودعم ذوي الهمم وخدمات المخيمات ودعم الأعزاء السجل القطاعي الموجز للسليمانية.",
        explore: "استكشف المشاريع",
      },
      kirkuk: {
        name: "كركوك",
        short: "كركوك",
        description:
          "ينتقل سجل كركوك من المساعدات الغذائية والمدرسية المبكرة إلى الصحة والمياه والدعم الأسري وخدمات ذوي الهمم وتنسيق المخيمات والمساعدات النقدية.",
        explore: "استكشف المشاريع",
      },
      nineveh: {
        name: "نينوى / الموصل",
        short: "الموصل",
        description:
          "يحمل التسلسل الزمني لنينوى أبرز سردية للنزوح: الغذاء الطارئ ودعم المخيمات والرعاية الصحية والمياه والتعليم والمأوى ومساعدة ذوي الهمم ودعم العودة.",
        explore: "استكشف المشاريع",
      },
      sinjar: {
        name: "سنجار / شنكال",
      ...
      garmian: {
        ...
        short: "كرميان",
        description:
          "يركز سجل كرميان الموجز على الغذاء والصحة والمهارات والإغاثة الأسرية والمياه ومساعدة ذوي الهمم والدعم النقدي.",
        explore: "استكشف المشاريع",
      },
      halabja: {
        name: "حلبجة",
        short: "حلبجة",
        description:
          "تتمثل أبرز قصص حلبجة في الغذاء والتعليم والمياه والمساعدات الأسرية ودعم النظام الصحي ومساعدة ذوي الهمم والمساعدات النقدية.",
        explore: "استكشف المشاريع",
      },
      raparin: {
        name: "رابرين",
        short: "رابرين",
        description:
          "تعرض شاشة رابرين البيانات التاريخية الموثقة لدعم الغذاء والتعليم والمياه والأعزاء، مع عدم توفر بيانات شاملة حديثة لعام ٢٠٢٤.",
        explore: "استكشف المشاريع",
      },
      soran: {
        name: "سوران",
      ...
      rojava: {
        ...
        short: "خارج كوردستان",
        description:
          "تجمع هذه الوجهة أعمال المؤسسة خارج كوردستان، وتتيح استعراض مشاريع وان والاستجابة لزلزال تركيا وسوريا وعفرين ولبنان.",
        explore: "استكشف المشاريع",
      },
      iraq: {
