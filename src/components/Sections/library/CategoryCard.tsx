...
export default function CategoryCard({ category }: CategoryCardProps) {
  ...
  return (
    <button
      type="button"
      className="flex w-24 shrink-0 flex-col items-center gap-2 rounded-2xl bg-[#F0EBE3] px-3 py-4 transition-colors hover:bg-[#E8E0D4] sm:w-28 lg:w-36 lg:gap-3 lg:py-6 xl:w-40 3xl:w-48 3xl:py-8"
    >
