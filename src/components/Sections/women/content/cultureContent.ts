  ...
  ku: [
    {
      ...
      teaser:
        "دەنگی ئازاری و بەرخۆدانی کورد گەیاند کاتێک قسەکردن بە کوردی لە گشتی نایاسایی بوو — هەرچۆنێک بێت گەیشت.",
      listIcon: "flower",
    },
    {
      id: "pakize-rafik-hilmi",
      ...
      teaser:
        "یەکەم خوێندکاری عێراقی بوو کە ماستەری هارڤارد بەدەستهێنا — زانستی کوردی کرد بە مێزەی جیهان.",
      listIcon: "crown",
    },
    {
      id: "roshan-bedirkhan",
      ...
      teaser:
        "هاوبەش لە بڵاوکردنەوەی گۆڤاری هەوار و ڕۆناهی، بەرگری لە پەروەردەی کچان و پاراستنی زمانی کوردی کرد.",
      listIcon: "crown",
    },
    {
      id: "nahida-sheikh-salam",
      name: "ناهیدە شێخ سەڵام",
      role: "نووسەر · پێشەنگی کولتووری · چالاکوان",
      teaser:
