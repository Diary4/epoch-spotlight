...
const content: Record<LangCode, ClosingContent> = {
  ...
  ku: {
    ...
    pageSubtitle: "جیاوازی، کەرامەت و داهاتوویەکی هاوبەش",
    pageLead: "لە کوردستان چەمکی \"کەمینە\" نییە — هەمووان ئەندامی یەکسانی کۆمەڵگەن لە ماف و پاراستندا.",
    cards: [
      {
        id: "respect",
        title: "ڕێزگرتن",
        body: "هەر ناسنامەیەک بەهای خۆی هەیە. لە کوردستان چەمکی \"کەمینە\" نییە — هەمووان ئەندامی یەکسانی کۆمەڵگەن لە ماف و پاراستندا.",
        icon: CARD_ICONS[0],
        accent: ACCENTS[0],
      },
      {
        id: "belonging",
        title: "ئینتیما",
        body: "لێرە شوێن بۆ هەمووان هەیە. هەمووان بەم خاکە دەڵێن نیشتمان.",
        icon: CARD_ICONS[1],
        accent: ACCENTS[1],
      },
      {
        id: "protection",
        title: "پاراستن",
        body: "ماف و کەلەپووری پێکهاتەکان هەم لە لایەن یاسا و پەرلەمانەوە و هەم لە ناو کولتوور و مێژووی گەلی کورددا، بە پارێزراوی ماونەتەوە.",
        icon: CARD_ICONS[2],
        accent: ACCENTS[2],
      },
      {
        id: "hope",
        title: "هیوا",
        body: "داهاتوو پێکەوە بنیاد دەنرێت. هەرێم بەردەوامە لە هەوڵەکانی بۆ ئاشتییەکی بەردەوام.",
        icon: CARD_ICONS[3],
        accent: ACCENTS[3],
      },
    ],
    ...
    sourcesIntro:
      "هەموو زانیارییەکانی ناو ئەم شاشەیە لە بڵاوکراوەی فەرمیی:",
    publicationTitleLine1: "کوردستان",
    publicationTitleLine2: "لانکەی پێکەوەژیان",
    publishedByLead: "وەرگیراون، کە لە لایەن",
    ministryName: "وەزارەتی ئەوقاف و کاروباری ئایینیی",
    governmentLine: "حکومەتی هەرێمی کوردستانەوە دەرچووە.",
