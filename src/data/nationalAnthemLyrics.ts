  ...
  // Cue 3 — line 1
  {
    ...
    words: {
      ku: [
        ...
        { text: "و", start: 40.04, end: 41.04 },
        { text: "کەیخوسرەوین", start: 41.2, end: 42.595 },
      ],
      en: [
        { text: "We", start: 36.04, end: 36.7 },
        { text: "are", start: 36.7, end: 37.3 },
        { text: "the", start: 37.3, end: 37.8 },
        { text: "sons", start: 37.8, end: 38.8 },
        { text: "of", start: 38.8, end: 39.3 },
        { text: "the", start: 39.3, end: 39.8 },
        { text: "Medes", start: 39.8, end: 41.3 },
        { text: "and", start: 41.3, end: 42.0 },
        { text: "Kai", start: 42.0, end: 43.1 },
        { text: "Khosrow", start: 43.1, end: 44.595 },
      ],
      ar: [
        { text: "نحن", start: 36.04, end: 37.3 },
        { text: "أبناء", start: 37.3, end: 39.0 },
        { text: "الميديين", start: 39.0, end: 41.2 },
        { text: "وكي", start: 41.2, end: 42.8 },
        { text: "خسرو", start: 42.8, end: 44.595 },
      ],
    },
  },
  // Cue 3 — line 2
  {
    ...
    words: {
      ku: [
        ...
        { text: "نیشتمان", start: 45.595, end: 48.595 },
        { text: "دینمان", start: 48.595, end: 49.595 },
        { text: "ئایینمان", start: 49.595, end: 50.595 },
        { text: "ھەر", start: 50.595, end: 51.595 },
        { text: "نیشتمان", start: 51.595, end: 53.75 },
      ],
      en: [
        { text: "Our", start: 44.595, end: 45.8 },
        { text: "homeland", start: 45.8, end: 48.0 },
        { text: "is", start: 48.0, end: 49.0 },
        { text: "our", start: 49.0, end: 50.0 },
        { text: "faith", start: 50.0, end: 51.6 },
        { text: "and", start: 51.6, end: 52.4 },
        { text: "religion", start: 52.4, end: 53.75 },
      ],
      ar: [
        { text: "ديننا", start: 44.595, end: 46.8 },
        { text: "إيماننا", start: 46.8, end: 49.3 },
        { text: "هو", start: 49.3, end: 51.0 },
        { text: "الوطن", start: 51.0, end: 53.75 },
      ],
    },
  },
];
