      ...
      */}
      ...
      >
        {onOpenDesignDraft && (
          <button
            type="button"
            onClick={onOpenDesignDraft}
            className="absolute end-3 top-3 z-20 rounded-full border border-[#c49b52]/60 bg-[#fffaf0]/90 px-3 py-1.5 text-[10px] font-medium uppercase tracking-[0.12em] text-[#9b6d35] shadow-sm backdrop-blur-sm transition-colors hover:bg-[#fff3dc] sm:end-6 sm:top-6 sm:px-4 sm:py-2 sm:text-xs"
          >
            Design draft
          </button>
        )}
