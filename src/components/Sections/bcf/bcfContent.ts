...
export const bcfCopy: Record<BcfLang, BcfCopy> = {
  ...
  ku: {
    ...
    dignity: "کەرامەت.",
    hope: "هیوا.",
    quote: "شانازیە بۆ مرۆڤ خزمەتکاری گەلی خۆی بێت",
    ...
    storySections: [
      ...
      },
      {
        ...
        body: "وتەی «شانازیە بۆ مرۆڤ خزمەتکاری گەلی خۆی بێت» تەنها دروشمێک نییە؛ بەڵکو بنەمای ئەخلاقیی کارەکانی دەزگای خێرخوازیی بارزانییە. کاری مرۆیی بەخشینێک نییە لە سەرەوە، بەڵکو خزمەتکردنە بە کەرامەتەوە.",
      },
      {
        id: "values",
        titleGold: "بەهاکانی",
