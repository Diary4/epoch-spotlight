    ...
    cards: [
      {
        ...
        title: "١١ کورسی کۆتا",
        body:
          "لە ٢٠٠٥ کورسی کەمینەکان زیادکرا: ٥ بۆ کلدو ئاشووری، ٥ بۆ تورکمان، ١ بۆ ئەرمەن.",
        icon: Vote,
        accent: "#52235f",
      },
      {
        ...
        body:
          "پەرلەمان بە کۆی دەنگ پەسەندی کرد. مافی سیاسی، ئایینی، کلتووری و زمانی هەموو پێکهاتەکان دەستەبەر دەکات.",
        icon: ScrollText,
        accent: "#7a4a12",
      },
      {
        ...
        body:
          "یاسا و بڕیارەکان پشووی تایبەتیان بۆ مەسیحی و ئێزیدییەکان جێگیر کردووە لە ساڵنامەی فەرمیدا.",
        icon: Calendar,
        accent: "#16466b",
      },
      {
        ...
        body:
          "بڕیاری ژمارە ١١ی ساڵی ٢٠١٩ ڕۆژی ٣ی ئابی وەک ڕۆژی جینۆساید ناساند.",
        icon: FileText,
        accent: "#6b1d1d",
      },
    ],
