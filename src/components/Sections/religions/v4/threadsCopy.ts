export const threadsCopy = {
    en: {
      ...
      openStory: "Explore 4 photo cards",
      collectionLabel: "Photo collection",
      collectionHint: "Use the large buttons or touch a card number",
      cardLabel: "Story card",
      previous: "Previous",
      next: "Next",
      back: "Back",
      home: "Threads",
    ...
    ku: {
      ...
      openStory: "٤ کارتی وێنەدار بدۆزەوە",
      collectionLabel: "کۆمەڵە وێنە",
      collectionHint: "دوگمە گەورەکان یان ژمارەی کارتێک دەست لێبدە",
      cardLabel: "کارتی چیرۆک",
      previous: "پێشوو",
      next: "دواتر",
      back: "گەڕانەوە",
      home: "تەنەکان",
    ...
    ar: {
      ...
      openStory: "استكشف 4 بطاقات مصوّرة",
      collectionLabel: "مجموعة مصوّرة",
      collectionHint: "استخدم الأزرار الكبيرة أو المس رقم البطاقة",
      cardLabel: "بطاقة الحكاية",
      previous: "السابق",
      next: "التالي",
      back: "العودة",
      home: "الخيوط",
