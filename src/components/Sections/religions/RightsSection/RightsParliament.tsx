...
const content: Record<"en" | "ku" | "ar", RightsDetailContent> = {
  ...
  ar: {
    ...
    cards: [
      {
        id: "seats",
        eyebrow: "١١ مقعداً محجوزاً",
        title: "تمثيل مضمون",
        body:
          "عام ٢٠٠٥ زاد برلمان كوردستان مقاعد الأقليات من ٥ إلى ١١: ٥ للكلدو-آشوريين، ٥ للتركمان، ١ للأرمن — ضمانة مكتوبة في القانون.",
        icon: Vote,
        accent: "#52235f",
      },
      {
        id: "law-5-2015",
        eyebrow: "قانون رقم ٥ لعام ٢٠١٥",
        title: "حقوق لكل المجتمعات",
        body:
          "صُوِّت عليه بالإجماع في برلمان كوردستان. يضمن الحقوق السياسية والدينية والثقافية واللغوية للتركمان والكلدان والسريان والأرمن والمسيحيين والإيزيديين والمندائيين والكاكائيين والزرادشتيين.",
        icon: ScrollText,
        accent: "#7a4a12",
      },
      {
        id: "holidays",
        eyebrow: "العطل الرسمية",
        title: "معترف بها في التقويم",
        body:
          "القرار رقم ٤٧ لعام ١٩٩٢ أرسى عطلاً للمسيحيين والآشوريين. القرار رقم ٦ لعام ٢٠١٠ أرسى عطل الإيزيديين. كل المجتمعات معترف بها في التقويم الرسمي.",
        icon: Calendar,
        accent: "#16466b",
      },
      {
        id: "genocide-day",
        eyebrow: "يوم الإبادة الإيزيدية",
        title: "٣ آب — يوم اعتراف",
        body:
          "القرار رقم ١١ لعام ٢٠١٩ أعلن رسمياً ٣ آب يوماً للإبادة الإيزيدية — معترفاً بجرائم داعش بوصفها إبادة جماعية وجرائم ضد الإنسانية وجرائم حرب.",
        icon: FileText,
        accent: "#6b1d1d",
      },
    ],
    tagline: "التمثيل ليس امتيازاً. إنه حق.",
  },
};
